...
file_name <- "04042019-002" #file name without the trailing csv
data_directory <- path("E:/Dropbox (Drummond Lab)/code_JB/")
n_samples <- 1 #used to double check inputs
#all parameters should be entered such that each sample has one entry in the lists
sample_names <- list("Nug1")
sample_dilutions <- list(c(0.1,0.1,0.1))
sample_wells_list <-list(c("A6","B6","C6"))
