...
file_name <- "190813-2-tsp-bradford-redo" #file name without the trailing csv
...
sample_names <- list("L_minus","L_plus","M_minus","H_plus")
sample_dilutions <- c(0.05,0.05,0.05) %>% list(.,.,.,.)
sample_wells_list <-list(c("D1","D2","D3"),c("E1","E2","E3"),
                         c("F1","F2","F3"),c("G1","G2","G3"))
